...
# github project reference: https://github.com/obfuscurity/synthesize
...
# todo: Package::repo::Setupcreate global repo
# todo: Package::repo::AutomateMaintenance: create automation logic have global Repo download the repos.  Ideally update this bit of code w/ #localRepoUrl
cd /usr/local/src
